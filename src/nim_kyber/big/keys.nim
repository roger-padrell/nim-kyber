import std/random, consts, matrix
randomize()

const rng = noiseRange;

proc generateSignalSecret*(): Matrix[2] = 
  var m: Matrix[2];
  var r = 0;
  var c = 0;
  while r < 2:
...
proc generateNoiseSecret*(): Matrix[2] = 
  var m: Matrix[2];
  var r = 0;
  var c = 0;
  while r < 2:
...
proc generatePublicTable*(): Matrix[4] = 
  var m: Matrix[4];
  var r = 0;
  var c = 0;
  while r < 4:
